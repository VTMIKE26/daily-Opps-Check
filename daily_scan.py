...
def build_competitor_section(intel_items: list, growth_items: list = None) -> str:
    ...
    fallback = "<p style='color:#aaa;font-size:13px;'>No competitor news this week.</p>"
    body = palantir_html + other_rc_html + (news_rows or fallback)
    return (
        '<div style="margin:20px 0 6px">'
        '<h2 style="font-size:16px;color:#222;border-bottom:2px solid #eee;'
        'padding-bottom:5px;">&#x1F50E; Competitor Intelligence</h2>'
