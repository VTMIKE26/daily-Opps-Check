...
CAPABILITY_CLUSTERS = [
    (
        ...
        [
            ...
            "multi-source data", "enterprise data platform",
            "data integration platform", "unified platform",
            "data ingestion", "data pipeline", "data consolidation",
            "information integration", "information sharing platform",
    ...
    (
        ...
        [
            ...
            "advanced analytics", "crime analytics",
            "predictive analytics", "intelligence platform",
            "all-source analytics", "mission analytics",
    ...
    (
        ...
        [
            ...
            "search across systems", "search multiple sources",
            "multi-system search", "search and retrieval",
            "information retrieval platform", "search capability",
            "knowledge retrieval", "query across",
            "semantic search", "full-text search platform",
    ...
    (
        ...
        [
            ...
            "record linkage", "record resolution",
            "duplicate records", "identity resolution",
            "entity matching", "data deduplication",
            "entity-centric", "record consolidation",
            "ontology", "knowledge graph", "graph analytics",
            "relationship graph", "entity graph",
            "master record", "person record resolution",
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            "records management system", "rms system",
            "computer-aided dispatch", "cad system",
            "first responder platform", "criminal investigation",
            "violent crime reduction", "gang intelligence",
            "crime reduction platform", "officer wellness",
            "body camera data", "evidence management platform",
    ...
    (
        ...
        [
            ...
            "pretrial services", "case supervision",
    ...
    (
        "Platform Modernization & Incumbent Replacement", 20,
        [
            "palantir", "palantir replacement", "palantir alternative",
            "gotham", "foundry",
            "ibm i2", "platform replacement",
            "incumbent replacement", "platform consolidation",
            "legacy platform", "legacy data platform",
            "platform modernization", "platform migration",
            "technology refresh", "system modernization",
            "legacy modernization", "replace existing platform",
